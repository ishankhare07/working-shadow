function getShadow(element, xPos, yPos) {
    ...
    pseudoElement = window.getComputedStyle(element);   //get element's computed style
    
    var current_left = pseudoElement.getPropertyValue('left');
    ...
    var current_top = pseudoElement.getPropertyValue('top');
